      ...
      <div class="group">
        ...
        <div style="display: flex; position: relative;">
          <div class="image-container" data-text="Click to view">
            <el-image :src="`/academicpage/image/project1.png`" alt="" class="gimg1" :preview-src-list="['/image/project1.png']"/>
          </div>
        </div>
      </div>
      <div class="group2">
        ...
        <div style="display: flex;">
          <div class="image-container" data-text="Click to view">
            <el-image :src="`/academicpage/image/project2_1.png`" alt="" class="gimg1" :preview-src-list="['/image/project2_1.png']"/>
          </div>
          <div class="image-container" data-text="Click to view">
            <el-image :src="`/academicpage/image/project2_2.png`" alt="" class="gimg2" :preview-src-list="['/image/project2_2.png']"/>
          </div>
        </div>
      </div>
